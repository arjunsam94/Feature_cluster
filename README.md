...
* Transforming categorical values of adoption rating under each feature (good, medium, poor) to numerical values using ordinal encoding.
...
## Result
Features like analytics and custom fields are clustered together in the scatter plot since they can be mapped to a customer goal of 'tracking team performance'. From here, any customer who has a good adoption rating for custom fields, which is available in the lower plan, can be nudged to try analytics in the higher plan to achieve the goal of tracking team performance. GTM team engagement efforts can also be aligned to these insights. 
